...
Get a good text editor or two. I want you to start playing around with these tools. If you search the internet for "Best text editors" there are a ton of articles. Here are a couple of articles to get you started. Windows specific [Best Text Editor For Windows In 2019](https://www.techtimes.com/brandspin/240045/20190325/top-5-best-text-editor-windows-2019.htm) and general [Best text editors in 2020](https://www.techradar.com/best/best-text-editors).
...
```{r, echo=FALSE}
blogdown::shortcode("figure", src ='"./data-curation/img/lesson-1/lesson-1/git-2.png"', link='"/data-curation/img/lesson-1/git-2.png"', alt = "Some alt text", caption = "The commit history page. ")
```
